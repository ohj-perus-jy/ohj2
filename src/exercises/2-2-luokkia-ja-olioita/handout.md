Tee luokka `Puhelin`, jolla on attribuutit `merkki` (merkkijono) ja `akku` (kokonaisluku, joka kuvaa akun varausta prosentteina väliltä 0-100). Lisää luokkaan seuraavat metodit:
